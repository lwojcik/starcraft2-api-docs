...
* [queryLadderSummary](/docs/methods/queryStaticProfileData.md)
* [queryPlayerLadder](/docs/methods/queryStaticProfileData.md)
* [queryGrandmasterLeaderboard](/docs/methods/queryStaticProfileData.md)
